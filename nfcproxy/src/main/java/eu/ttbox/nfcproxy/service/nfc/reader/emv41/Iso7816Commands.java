...
public class Iso7816Commands {
    ...
    private static final String TAG = "Iso7816Commands";
    ...
    public static byte[] selectMasterFile() {
        return NumUtil.hex2Byte("00 A4 00 00 00");
    }

     public static byte[] selectMasterFileByIdentifier() {
        return NumUtil.hex2Byte("00 A4 00 00 02 3F 00 00");
    }
    ...
    public static byte[] readRecord(int recordNum, int sfi) {
        ...
        Log.d(TAG, "Iso7816Commands.readRecord() P1=" + P1 + " P2=" + P2);
